...
class Experience extends Component {
  render() {
    ...
    if (this.props.resumeExperience && this.props.resumeBasicInfo && this.props.resumeBasicInfo.section_name) {
      sectionName = this.props.resumeBasicInfo.section_name.experience;
      
      workElements = this.props.resumeExperience.map(function (work, i) {
